            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                ...
                <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu" onclick="window.location.href='product_view.php'">View Products</span>
                </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                ...
                <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu" onclick="window.location.href='product_register.php'">Add products</span>
                </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between has-arrow" href="javascript:void(0)" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu" onclick="window.location.href='availablebrands.php'">available Brands</span>
                </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between has-arrow" href="javascript:void(0)" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu" onclick="window.location.href='availablecategory.php'">Available Categories</span>
                </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                ...
                <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu" onclick="window.location.href='sellerprofile.php'">User Profile</span>
                </div>
