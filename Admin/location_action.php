...
if (isset($_POST['submit'])) {
    ...
    if ($rows == 1) {
        ...
        echo  $sqlquery1 = "INSERT INTO tbl_location(location_name,district_id) VALUES('$locationname','$districtid')";
        $result1 = $obj->executequery($sqlquery1);
        if ($result1 == 1) {
            echo "<script>alert('Registration Succesfully!!');window.location='location_view.php'</script>";
        } else {
